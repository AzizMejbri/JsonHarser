...
/* package jsonparser-0.1.0.0 */
#ifndef VERSION_jsonparser
#define VERSION_jsonparser "0.1.0.0"
#endif /* VERSION_jsonparser */
#ifndef MIN_VERSION_jsonparser
#define MIN_VERSION_jsonparser(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_jsonparser */
...
#define CURRENT_COMPONENT_ID "jsonparser-0.1.0.0-inplace-jsonparser"
